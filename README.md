...
## Step 1: .Env file
go to Slack #dev-environment channel and download env.txt file
after downloading add file to root of the project and rename it to ".env" instead of "env.txt"
